...
function printTodo({ id, userId, title, completed }) {
    ...
    li.className = 'todo-item flex gap-[1rem] p-[8px] border-[1px] border-[#000000] border-solid my-[8px] flex items-center';
    li.style.hover = 'tomato'
    li.dataset.id = id;
    ...
    close.className = 'close text-[tomato] cursor-pointer font-black ml-auto text-[28px]';
